...
<div class="container-fluid px-2 py-2">
            ...
            <table class="table table-hover align-middle mb-0" width="100%">
                ...
                <tbody style="color: #334155;">
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9;">
                        <td class="py-3 ps-3">{{$loop->index}}</td>
    ...
    <div class="text-muted" style="font-size:12px;">
        Menampilkan {{ $masterJadwals->firstItem() ?? 0 }}-{{ $masterJadwals->lastItem() ?? 0 }}
        dari {{ $masterJadwals->total() }} data master jadwal
    </div>

    <div class="sm-pagination">
        {{ $masterJadwals->links('pagination::bootstrap-5') }}
    </div>
