...
class JadwalPenjemputanController extends Controller
{
        ...
        try {
            ...
            */
            $jadwalAdmin = JadwalPenjemputan::with(['nasabah', 'kurir', 'bankSampah'])
                ...
                ->toArray(); // ðŸ”¥ Ubah ke array murni PHP
    ...
    /**
     * ðŸ”„ PATCH: KURIR MULAI PENJEMPUTAN (status â†’ proses)
     */
    public function mulaiJemput($id)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'ðŸšš Status berhasil diperbarui! Kurir sedang dalam perjalanan menuju lokasi.',
                'data' => $jadwal
            ], 200);
    ...
    /**
     * ðŸ”„ PATCH: KURIR BATALKAN JADWAL PENJEMPUTAN (status â†’ dibatalkan)
     */
    ...
    /**
     * =========================================================================
     * ðŸ“… JADWAL NASABAH â€” Dipanggil Flutter halaman nasabah
     * Mengembalikan:
